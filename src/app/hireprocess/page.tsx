    ...
    <div className="min-h-screen bg-gradient-to-br bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
            ...
            <div className="text-center">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-50 text-blue-800">
            ...
            <div className="text-center py-6">
              <button className="px-4 py-2 border-balck w-fit rounded-xl border-2 bg-blue-600 px-4 py-2  text-white transition-all hover:border-black hover:bg-blue-50 hover:bg-transparent  hover:text-black/90">
              <Link href="/hireprocess/jobdetails"> Next Step</Link>
