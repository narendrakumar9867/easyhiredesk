    ...
    <div className="min-h-screen bg-gradient-to-br bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">
                Add Your <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Job Details</span>
            </h1>
            ...
            <div className="px-8 py-6 bg-white border-t border-gray-200 flex flex-col sm:flex-row gap-4 justify-end">
                ...
                <button className="px-8 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors duration-200 flex items-center justify-center">
                  <Link href="/hireprocess/jobdetails/rounds">
